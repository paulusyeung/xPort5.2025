...
namespace xPort3.Admin.Coding.User.Address
{
    public partial class AddressList : UserControl
    {
        ...
        private void SetAttribute()
        {
            ...
            string[] phones = xPort3.Controls.Utility.Default.PhoneLabels4User();
        ...
        private void SetPackageAns()
        {
            ...
            cmdRefresh.Image = new IconResourceHandle("Icons.16x16.16_L_refresh.gif");
...
", _UserId.ToString());
            ...
            while (reader.Read())
            {
                ...
                {
                    objItem.SmallImage = new IconResourceHandle("Icons.16x16.vcard_key_16.png");
                    objItem.LargeImage = new IconResourceHandle("Icons.16x16.vcard_key_16.png");
                }
                else
                {
                    objItem.SmallImage = new IconResourceHandle("Icons.16x16.vcard.png");
                    objItem.LargeImage = new IconResourceHandle("Icons.16x16.vcard.png");
                }
                #endregion
                ...
                {
                    objItem.SubItems.Add(new IconResourceHandle("Icons.16x16.mailing_on_16.png").ToString());
                }
                else
                {
                ...
                if (lvwAddress.CheckBoxes && lvwAddress.CheckedIndices.Count > 0)
                {
                    foreach (ListViewItem item in lvwAddress.CheckedItems)
                    {
                        if (Common.Utility.IsGUID(item.SubItems[1].Text))
                        {
                            ...
                            if (xPort3.Controls.Utility.ProductSupplier.DeleteRec(aSupplierId))
                            {
                                item.Remove();
                            }
                        }
