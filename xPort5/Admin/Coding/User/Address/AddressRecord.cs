...
namespace xPort3.Admin.Coding.User.Address
{
    public partial class AddressRecord : Form
    {
        ...
        {
            string[] phoneLabels = xPort3.Controls.Utility.Default.PhoneLabels4User();
        ...
        {
            xPort3.DAL.Z_Address.LoadCombo(ref cboAddress, "AddressName", false);
        }
        ...
        private void SetAnsToolbar()
        {
            ...
            // cmdSaveNew
            ToolBarButton cmdSaveNew = new ToolBarButton("Save & Dup", oDict.GetWord("Save_New").Replace("%26", "&"));
            cmdSaveNew.Tag = "Save & New";
            cmdSaveNew.Image = new IconResourceHandle("Icons.16x16.16_L_saveOpen.gif");
...
//                this.ansToolbar.Buttons.Add(cmdSaveNew);
        ...
        {
            xPort3.DAL.Staff user = xPort3.DAL.Staff.Load(_UserId);
            if (user != null)
            {
        ...
        private void ShowUserAddress()
        {
            ...
            if (uAddress != null)
            {
                ...
                xPort3.DAL.Staff s1 = xPort3.DAL.Staff.Load(uAddress.CreatedBy);
                xPort3.DAL.Staff s2 = xPort3.DAL.Staff.Load(uAddress.ModifiedBy);
                ...
                try
                {
                    ...
                    switch ((int)_EditMode)
                    {
                        case (int)Common.Enums.EditMode.Add:
                            ...
                            if (xPort3.Controls.Utility.StaffAddress.Count(_UserId) == 0)
                            {
                            ...
                            Guid[] labelIds = xPort3.Controls.Utility.Default.PhoneLabelIds4User();
        ...
        {
            return xPort3.Controls.Utility.StaffAddress.DeleteRec(_UserAddressId);
        }
        #endregion
