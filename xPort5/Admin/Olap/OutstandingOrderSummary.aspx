<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OutstandingOrderSummary.aspx.cs" 
    Inherits="xPort5.Admin.Olap.OutstandingOrderSummary" %>
...
<body>
    ...
    <div id="divPivotGrid" style="font: 10pt Tahoma; border-right: 0; border-top: 0;
        ...
        <dxwpg:ASPxPivotGridExporter ID="olapOSOrderExporter" runat="server" ASPxPivotGridID="olapOSOrder" />
        <dxwpg:ASPxPivotGrid ID="olapOSOrder" runat="server" 
        ...
        <asp:SqlDataSource ID="olapSqlDataSource" runat="server" 
            ConnectionString="<%$ ConnectionStrings:SysDb %>" SelectCommand="olap_OSOrder" 
