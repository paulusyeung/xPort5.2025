<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalesContract.aspx.cs" Inherits="xPort5.Admin.Olap.SalesContract" %>
...
<body>
    ...
    <div id="divPivotGrid" style="font: 10pt Tahoma; border-right: 0; border-top: 0;
        ...
        <dxwpg:ASPxPivotGridExporter ID="olapSalesContractExporter" runat="server" ASPxPivotGridID="olapSalesContract" />
        <dxwpg:ASPxPivotGrid ID="olapSalesContract" runat="server" 
            DataSourceID="olapSqlDataSource" onprerender="olapSalesContract_PreRender">
            ...
            <Fields>
                ...
                <dxwpg:PivotGridField Area="RowArea" AreaIndex="1" Caption="Currency" 
                    FieldName="CurrencyCode">
                </dxwpg:PivotGridField>
                <dxwpg:PivotGridField Area="RowArea" AreaIndex="2" Caption="Sales Contract" 
                    FieldName="SCNumber" MinWidth="40">
                </dxwpg:PivotGridField>
                <dxwpg:PivotGridField Area="RowArea" AreaIndex="3" Caption="Article Code" 
                    FieldName="ArticleCode">
                </dxwpg:PivotGridField>
                <dxwpg:PivotGridField Area="ColumnArea" AreaIndex="0" Caption="Year" 
                    FieldName="SCDate" GroupInterval="DateYear">
                </dxwpg:PivotGridField>
                <dxwpg:PivotGridField Area="ColumnArea" AreaIndex="1" Caption="Month" 
                    FieldName="SCDate" GroupInterval="DateMonth" GroupIntervalNumericRange="3">
                </dxwpg:PivotGridField>
                ...
                <dxwpg:PivotGridField Area="FilterArea" AreaIndex="1" Caption="Quarter" 
                    FieldName="SCDate" GroupInterval="DateQuarter">
                </dxwpg:PivotGridField>
                <dxwpg:PivotGridField Area="DataArea" AreaIndex="0" Caption="Amount" 
                    CellFormat-FormatString="{0:n2}" CellFormat-FormatType="Numeric" 
                    FieldName="ExtAmount">
                </dxwpg:PivotGridField>
                <dxwpg:PivotGridField Area="DataArea" AreaIndex="1" Caption="HKD Amount" 
                    CellFormat-FormatString="{0:n2}" CellFormat-FormatType="Numeric" 
                    FieldName="ExtHKDAmount">
                </dxwpg:PivotGridField>
            </Fields>
        ...
        <asp:SqlDataSource ID="olapSqlDataSource" runat="server" 
            ...
            SelectCommand="olap_SalesContract" SelectCommandType="StoredProcedure">
            <SelectParameters>
                <asp:ControlParameter ControlID="CustomerId" Name="CustomerId_Array" 
                    PropertyName="Value" Type="String" />
                <asp:ControlParameter ControlID="FromDate" Name="FromDate" PropertyName="Value" 
                    Type="String" />
                <asp:ControlParameter ControlID="ToDate" Name="ToDate" PropertyName="Value" 
                    Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
    </div>
