<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Top10Suppliers.aspx.cs"
    Inherits="xPort5.Admin.Olap.Top10Suppliers" %>
...
<body>
    ...
    <div id="divPivotGrid" style="font: 10pt Tahoma; border-right: 0; border-top: 0;
        ...
        <dxwpg:ASPxPivotGrid ID="olapSalesTurnover" runat="server" 
            ...
            <Fields>
                <dxwpg:PivotGridField Area="RowArea" AreaIndex="0" Caption="Supplier Name" 
                    FieldName="SuppName">
                </dxwpg:PivotGridField>
                <dxwpg:PivotGridField Area="RowArea" AreaIndex="1" Caption="Pricing Terms" 
                    FieldName="PricingTerms">
                </dxwpg:PivotGridField>
                <dxwpg:PivotGridField Area="RowArea" AreaIndex="2" Caption="Contract Number" 
                    FieldName="PCNumber" MinWidth="40">
                </dxwpg:PivotGridField>
                ...
                <dxwpg:PivotGridField Area="ColumnArea" AreaIndex="0" Caption="Year" 
                    FieldName="PCDate" GroupInterval="DateYear">
                </dxwpg:PivotGridField>
                ...
                <dxwpg:PivotGridField Area="FilterArea" AreaIndex="1" Caption="Quarter" 
                    FieldName="PCDate" GroupInterval="DateQuarter">
                </dxwpg:PivotGridField>
                <dxwpg:PivotGridField Area="FilterArea" AreaIndex="2" Caption="Month" 
                    FieldName="PCDate" GroupInterval="DateMonth">
                </dxwpg:PivotGridField>
                ...
                <dxwpg:PivotGridField Area="DataArea" AreaIndex="2" Caption="Over All" 
                    Visible="False">
                </dxwpg:PivotGridField>
            </Fields>
            ...
            <OptionsView ShowColumnGrandTotals="False" ShowColumnTotals="False" ShowGrandTotalsForSingleValues="True"
                ShowRowTotals="False" />
        </dxwpg:ASPxPivotGrid>
        <asp:SqlDataSource ID="olapSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:SysDb %>"
            SelectCommand="olap_Top10Supplier" SelectCommandType="StoredProcedure">
            <SelectParameters>
                <asp:ControlParameter ControlID="SupplierId" Name="SupplierId_Array" PropertyName="Value"
                    Type="String" />
                <asp:ControlParameter ControlID="FromDate" Name="FromDate" PropertyName="Value" Type="String" />
                <asp:ControlParameter ControlID="ToDate" Name="ToDate" PropertyName="Value" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
    </div>
