<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShipmentSummary.aspx.cs" Inherits="xPort5.Admin.Olap.ShipmentSummary" %>
...
<body>
    ...
    <div id="divPivotGrid" style="font: 10pt Tahoma; border-right: 0; border-top: 0;
        ...
        <dxwpg:ASPxPivotGridExporter ID="olapShipmentSummaryExporter" runat="server" ASPxPivotGridID="olapShipmentSummary" />
        <dxwpg:ASPxPivotGrid ID="olapShipmentSummary" runat="server" 
            DataSourceID="olapSqlDataSource">
        ...
        <asp:SqlDataSource ID="olapSqlDataSource" runat="server" 
            ...
            SelectCommand="olap_ShipmentSummary" SelectCommandType="StoredProcedure">
            <SelectParameters>
                ...
                <asp:ControlParameter ControlID="FromDate" Name="FromDate" PropertyName="Value" 
                    Type="String" />
                <asp:ControlParameter ControlID="Currency" Name="CurrencyCode" 
                    PropertyName="Value" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
    </div>
