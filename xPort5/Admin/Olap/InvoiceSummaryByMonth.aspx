<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvoiceSummaryByMonth.aspx.cs"
    Inherits="xPort5.Admin.Olap.InvoiceSummaryByMonth" %>
...
<body>
    ...
    <div id="divPivotGrid" style="font: 10pt Tahoma; border-right: 0; border-top: 0;
        ...
        <dxwpg:ASPxPivotGridExporter ID="olapInvoiceByMonthExporter" runat="server" ASPxPivotGridID="olapInvoiceByMonth" />
