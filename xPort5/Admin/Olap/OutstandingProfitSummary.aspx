<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OutstandingProfitSummary.aspx.cs" Inherits="xPort5.Admin.Olap.OutstandingProfitSummary" %>
...
<body>
    ...
    <div id="divPivotGrid" style="font: 10pt Tahoma; border-right: 0; border-top: 0;
        ...
        <dxpgw:ASPxPivotGridExporter ID="olapOSProfitExporter" runat="server" ASPxPivotGridID="olapOSProfit" />
        <dxwpg:ASPxPivotGrid ID="olapOSProfit" runat="server" 
        ...
        <asp:SqlDataSource ID="olapSqlDataSource" runat="server" 
            ConnectionString="<%$ ConnectionStrings:SysDb %>" SelectCommand="olap_OSProfit" 
