...
{
    public partial class SalesTurnover : System.Web.UI.Page
    {
        ...
        private void InitialValues()
        {
            ...
            if (period.Length > 1)
            {
                ...
                {
                    //this.olapSqlDataSource.ConnectionString = Common.Config.ConnectionString;
                    //this.olapSqlDataSource.SelectCommand = "Olap_SalesTurnover";
                    //this.olapSqlDataSource.SelectCommandType = SqlDataSourceCommandType.StoredProcedure;
                    //this.olapSqlDataSource.SelectParameters.Add("CustomerId_Array", custList.ToString());
                    //this.olapSqlDataSource.SelectParameters.Add("FromDate", period[0] + " 00:00:00");
                    //this.olapSqlDataSource.SelectParameters.Add("ToDate", period[1] + " 23:59:59");
                    //this.olapSqlDataSource.DataBind();
        ...
        {
           foreach(DevExpress.Web.ASPxPivotGrid.PivotGridField field in olapSalesTurnover.Fields)
           {
               field.CollapseAll();
           }
        }
