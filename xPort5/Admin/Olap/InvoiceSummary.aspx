<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvoiceSummary.aspx.cs" Inherits="xPort5.Admin.Olap.InvoiceSummary" %>
...
<body>
    ...
    <div id="divPivotGrid" style="font: 10pt Tahoma; border-right: 0; border-top: 0;
        ...
        <dxwpg:ASPxPivotGridExporter ID="olapInvoiceSummaryExporter" runat="server" ASPxPivotGridID="olapInvoiceSummary" />
        <dxwpg:ASPxPivotGrid ID="olapInvoiceSummary" runat="server" 
        ...
        <asp:SqlDataSource ID="olapSqlDataSource" runat="server" 
            ...
            SelectCommand="olap_InvoiceSummary" SelectCommandType="StoredProcedure">
            <SelectParameters>
