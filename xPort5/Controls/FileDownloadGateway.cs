...
namespace xPort5.Controls
{
    ...
    /// </summary>
    /// <remarks></remarks>
    [MetadataTag("Job.Book.Controls.FileDownloadGateway")]
    public class FileDownloadGateway : Control, IGatewayComponent
    {
        private string contenttype;
        private string dispositiontype = "attachment";
        ...
        public void ProcessRequest(IContext objContext, string strAction)
        {
            ...
            if (this.downloadattachment && !String.IsNullOrEmpty(Filename))
                objResponse.AddHeader("content-disposition", String.Format("{0}; filename=\"", this.dispositiontype) + this.Filename + "\"");
