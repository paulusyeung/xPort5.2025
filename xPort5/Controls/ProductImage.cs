...
{
    /// <summary>
    /// Load the image from Web.config '<Directory Code="ProductImage" Path="D:\Shared\xPort5\ProductImage\" />'
    /// </summary>
    public class ProductImage : PictureBox, IGatewayComponent
    {
        ...
        public virtual string ImageName
        {
            ...
            set
            {
                ...
                {
                    // If there is no image loaded, load the default emty image.
        ...
        protected override IGatewayHandler ProcessGatewayRequest(HttpContext objContext, string strAction)
        {
            ...
            if (imageName.Length != 0)
            {
                ...
                System.Drawing.Image NewImage = xPort5.Controls.Utility.Resources.GetPicture(imageName, NewWidth, MaxHeight, OnlyResizeIfWider);
