...
namespace xPort5.Order.Coding.Product.Supplier
{
    public partial class SupplierRecord : Form
    {
        ...
        private void SetCaptions()
        {
            ...
            this.lblRefNumber.Text = oDict.GetWordWithColon("ref_number");
            this.lblFCL.Text = oDict.GetWordWithColon("fcl_cost");
            this.lblLCL.Text = oDict.GetWordWithColon("lcl_cost");
