...
namespace xPort5.Order.Coding.Product.Package
{
    public partial class PackageList : UserControl
    {
        ...
        private void SetCaptions()
        {
            ...
            colDescription.Text = oDict.GetWord("package");
        ...
        private void SetLvwList()
        {
            ...
            lvwPackage.Tag = new Guid("B874A25B-8C69-4db3-853D-92DFBE1C5B2E");
        ...
        private void SetPackageAns()
        {
            ...
            {
                if (xPort5.Controls.Utility.NetSqlAzMan.IsAccessAuthorized("Order", "Coding.Product.Create"))
                {
            ...
            if (_EditMode == Common.Enums.EditMode.Edit)
            {
                if (xPort5.DAL.Common.Config.UseNetSqlAzMan)
                {
                    if (xPort5.Controls.Utility.NetSqlAzMan.IsAccessAuthorized("Order", "Coding.Product.Delete"))
                    {
