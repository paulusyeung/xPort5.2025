...
{
    public partial class PriceListSampleRequestXr_Pdf : DevExpress.XtraReports.UI.XtraReport
    {
        private decimal sum = 0;
        private string shippingmark = "";

        public PriceListSampleRequestXr_Pdf(string parameters)
        {
            InitializeComponent();
        ...
        private void Detail_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            this.txtColor.Text = "COLOR: " + GetCurrentColumnValue("AgeGrading").ToString();
