...
{
    public partial class PriceListXr_Xls : DevExpress.XtraReports.UI.XtraReport
    {
        private decimal sum = 0;
        private string shippingmark = "";

        public PriceListXr_Xls(string parameters)
        {
            InitializeComponent();
        }
        ...
        private void Detail_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            this.txtUnit.Text = String.Format(@" / {0}", GetCurrentColumnValue("Unit").ToString());
            this.txtUnitPrice.Text = "$" + Convert.ToDecimal(GetCurrentColumnValue("UnitAmt")).ToString("n2");
        }
