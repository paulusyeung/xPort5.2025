...
{
    public partial class QuotationXr_Pdf : DevExpress.XtraReports.UI.XtraReport
    {
        private decimal sum = 0;
        private string shippingmark = "";

        public QuotationXr_Pdf()
        {
            InitializeComponent();
        ...
        private void gh1_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            this.lblUnitPrice.Text = String.Format("Unit Price ({0})", GetCurrentColumnValue("CurrencyUsed").ToString().ToUpper());
        }
        ...
        private void Detail_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            this.txtUnitPrice.Text = String.Format("${0} / {1}", Convert.ToDecimal(GetCurrentColumnValue("UnitAmt")).ToString("n3"), GetCurrentColumnValue("Unit").ToString().ToUpper());
        }
