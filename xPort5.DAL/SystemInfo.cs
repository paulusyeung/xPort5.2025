...
namespace xPort5.DAL
{
    ...
    /// Date Created:   2020-03-02 02:26:45
    ...
    public class SystemInfo
    {
        ...
        /// </summary>
        public SystemInfo(Guid systemId, string ownerName, Dictionary<id, MetadataAttributes> metadataXml)
        {
        ...
        /// <summary>
        /// Loads a SystemInfo object from the database using the given SystemId
        /// </summary>
        /// <param name="systemId">The primary key value</param>
        /// <returns>A SystemInfo object</returns>
        public static SystemInfo Load(Guid systemId)
        {
            SqlParameter[] parameterValues = new SqlParameter[] { new SqlParameter("@SystemId", systemId) };
        ...
        public void LoadFromReader(SqlDataReader reader)
        {
            if (reader != null && !reader.IsClosed)
            {
                ...
                {
                    this.PrepareMetadataXml(reader.GetSqlXml(2), out this.metadataXml);
                }
        ...
        private void Insert()
        {
            ...
            SqlHelper.Default.ExecuteNonQuery("spSystemInfo_InsRec", "@SystemId", out returnedValue, parameterValues);

            systemId = returnedValue != null ? (Guid)returnedValue : Guid.Empty;
        ...
        private SqlParameter[] GetInsertParameterValues()
        {
            ...
            prams[0] = GetSqlParameter("@SystemId", ParameterDirection.Output, SqlDbType.UniqueIdentifier, 16, this.SystemId);
            prams[1] = GetSqlParameter("@OwnerName", ParameterDirection.Input, SqlDbType.NVarChar, 255, this.OwnerName);
            prams[2] = GetSqlParameter("@MetadataXml", ParameterDirection.Input, SqlDbType.Xml, -1, this.GenerateXml(this.MetadataXml));
            return prams;
        }
        ...
        public override string ToString()
        {
            ...
            builder.Append("systemId: " + systemId.ToString()).Append("\r\n");
            builder.Append("ownerName: " + ownerName.ToString()).Append("\r\n");
        ...
        public static void LoadCombo(ref ComboBox ddList, string[] TextField, string TextFormatString, bool SwitchLocale, bool BlankLine, string BlankLineText, string ParentFilter, string WhereClause, string[] OrderBy)
        {
            ...
            foreach (SystemInfo item in source)
            {
                ...
                if (!(filter))
                {
                    ...
                    sourceList.Add(new Common.ComboItem(code, item.SystemId));
                }
            }
