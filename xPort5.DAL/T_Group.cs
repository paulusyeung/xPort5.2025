...
{
    /// <summary>
    /// This Data Access Layer Component (DALC) provides access to the data contained in the data table dbo.T_Group.
    /// Date Created:   2020-03-02 01:59:33
    ...
    public class T_Group
    {
        ...
        /// <summary>
        /// Initialize an new empty T_Group object.
        /// </summary>
        public T_Group()
        {
        }
        ...
        /// <summary>
        /// Initialize a new T_Group object with the given parameters.
        /// </summary>
        public T_Group(Guid groupId, Guid parentGroup, string groupCode, string groupName, string groupName_Chs, string groupName_Cht)
        {
        ...
        /// <summary>
        /// Loads a T_Group object from the database using the given GroupId
        /// </summary>
        /// <param name="groupId">The primary key value</param>
        /// <returns>A T_Group object</returns>
        public static T_Group Load(Guid groupId)
        {
            SqlParameter[] parameterValues = new SqlParameter[] { new SqlParameter("@GroupId", groupId) };
            using (SqlDataReader reader = SqlHelper.Default.ExecuteReader("spT_Group_SelRec", parameterValues))
            {
                if (reader.Read())
                {
                    T_Group result = new T_Group();
        ...
        /// <summary>
        /// Loads a T_Group object from the database using the given where clause
        /// </summary>
        ...
        public static T_Group LoadWhere(string whereClause)
        {
            ...
            using (SqlDataReader reader = SqlHelper.Default.ExecuteReader("spT_Group_SelAll", parameterValues))
            {
                if (reader.Read())
                {
                    T_Group result = new T_Group();
        ...
        /// <summary>
        /// Loads a collection of T_Group objects from the database.
        /// </summary>
        /// <returns>A collection containing all of the T_Group objects in the database.</returns>
        public static T_GroupCollection LoadCollection()
        {
            SqlParameter[] parms = new SqlParameter[] { };
            return LoadCollection("spT_Group_SelAll", parms);
        }

        /// <summary>
        /// Loads a collection of T_Group objects from the database ordered by the columns specified.
        /// </summary>
        /// <returns>A collection containing all of the T_Group objects in the database ordered by the columns specified.</returns>
        ...
        /// </summary>
        /// <returns>A collection containing all of the T_Group objects in the database.</returns>
        public static T_GroupCollection LoadCollection(string spName, SqlParameter[] parms)
        {
            T_GroupCollection result = new T_GroupCollection();
            using (SqlDataReader reader = SqlHelper.Default.ExecuteReader(spName, parms))
            {
                while (reader.Read())
                {
                    T_Group tmp = new T_Group();
        ...
        /// <summary>
        /// Deletes a T_Group object from the database.
        /// </summary>
        /// <param name="groupId">The primary key value</param>
        public static void Delete(Guid groupId)
        {
            SqlParameter[] parameterValues = new SqlParameter[] { new SqlParameter("@GroupId", groupId) };
            SqlHelper.Default.ExecuteNonQuery("spT_Group_DelRec", parameterValues);
        }
        ...
        private void Insert()
        {
            ...
            SqlHelper.Default.ExecuteNonQuery("spT_Group_InsRec", "@GroupId", out returnedValue, parameterValues);
        ...
        private void Update()
        {
            ...
            SqlHelper.Default.ExecuteNonQuery("spT_Group_UpdRec", parameterValues);
        }
        ...
        private SqlParameter[] GetInsertParameterValues()
        {
            ...
            prams[2] = GetSqlParameter("@GroupCode", ParameterDirection.Input, SqlDbType.VarChar, 3, this.GroupCode);
        ...
        private SqlParameter[] GetUpdateParameterValues()
        {
            return new SqlParameter[]
            {
                ...
                GetSqlParameterWithoutDirection("@GroupCode", SqlDbType.VarChar, 3, this.GroupCode),
        ...
        public static void LoadCombo(ref ComboBox ddList, string[] TextField, string TextFormatString, bool SwitchLocale, bool BlankLine, string BlankLineText, string ParentFilter, string WhereClause, string[] OrderBy)
        {
            ...
            {
                source = T_Group.LoadCollection(WhereClause, OrderBy, true);
            }
            else
            {
                source = T_Group.LoadCollection(OrderBy, true);
            }
        ...
        private static bool IgnorThis(T_Group target, string parentFilter)
        {
            bool result = true;
            ...
            {
                T_Group parentTemplate = T_Group.Load(target.ParentGroup);
                result = IgnorThis(parentTemplate, parentFilter);
            }
            return result;
        }

        private static string GetFormatedText(T_Group target, string[] textField, string textFormatString)
        {
    ...
    /// <summary>
    /// Represents a collection of <see cref="T_Group">T_Group</see> objects.
    /// </summary>
    public class T_GroupCollection : BindingList<T_Group>
    {
    }
}
