...
namespace xPort5.DAL
{
    ...
    /// Date Created:   2020-03-02 02:31:30
    ...
    public class UserPreference
    {
        ...
        private Guid preferenceObjectId = Guid.Empty;
        ...
        /// </summary>
        public UserPreference(Guid preferenceId, Guid userId, Guid preferenceObjectId, Dictionary<id, MetadataAttributes> metadataXml)
        {
            this.preferenceId = preferenceId;
            this.userId = userId;
            this.preferenceObjectId = preferenceObjectId;
        ...
        public static UserPreference Load(Guid preferenceId)
        {
        ...
        public void LoadFromReader(SqlDataReader reader)
        {
            if (reader != null && !reader.IsClosed)
            {
                ...
                if (!reader.IsDBNull(1)) userId = reader.GetGuid(1);
                if (!reader.IsDBNull(2)) preferenceObjectId = reader.GetGuid(2);
        ...
        public Guid PreferenceObjectId
        {
            get { return preferenceObjectId; }
            set { preferenceObjectId = value; }
        }
        ...
        private SqlParameter[] GetInsertParameterValues()
        {
            ...
            prams[1] = GetSqlParameter("@UserId", ParameterDirection.Input, SqlDbType.UniqueIdentifier, 16, this.UserId);
            prams[2] = GetSqlParameter("@PreferenceObjectId", ParameterDirection.Input, SqlDbType.UniqueIdentifier, 16, this.PreferenceObjectId);
        ...
        private SqlParameter[] GetUpdateParameterValues()
        {
            return new SqlParameter[]
            {
                ...
                GetSqlParameterWithoutDirection("@PreferenceObjectId", SqlDbType.UniqueIdentifier, 16, this.PreferenceObjectId),
        ...
        public override string ToString()
        {
            ...
            builder.Append("preferenceObjectId: " + preferenceObjectId.ToString()).Append("\r\n");
